...
Rule no - 6 - if the position is not provided than it will start from 0 and search the string from the beginning and return the first match

Rule no - 7 - if the postion is greater than the string length than it will return -1

Rule no -8- the spaces are also counted in the string length
